    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-lg-4">
                        @if ($item_join->bukti_img!="")
                        <img src="{{asset('/images/participant_payments/'.$item_join->bukti_img)}}" class="img-fluid img-thumbnail mt-3" alt="Photo of sunset">
                        @else
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="list-group-item"> Nama : {{$item_join->username}}</p>
                        <p class="list-group-item"> Asal Sekolah : {{$item_join->asal_sekolah}}</p>
                        <p class="list-group-item"> tanggal upload : {{$item_join->updated_at}}</p>
                        <p class="list-group-item"> Jenis Peserta : {{$item_join->jenis_peserta}}</p>
                        <p class="list-group-item"> No.Hp : {{$item_join->no_hp}}</p>
                        <p>
