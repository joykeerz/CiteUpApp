                ...
                <div class="user-wrapper">
                        <a class="user-link" href="#">
                            ...
                            <p class="user-info menu_hide" style="color: darkslategrey">
                                {{ Auth::user()->username }}
                                <br>
                                @if ($value->jenis_peserta == 'anggota' && Auth::user()->role == 'peserta')
                                {{ $value->jenis_peserta }}
                                @elseif($value->jenis_peserta == 'ketua' && Auth::user()->role == 'peserta' )
                                {{ $value->jenis_peserta }}
                                @elseif($value->jenis_peserta == 'ketua' && Auth::user()->role == 'admin')
                                Pengurus Cite Up
                                @elseif($value->jenis_peserta == 'anggota' && Auth::user()->role == 'admin')
                                Pengurus Cite Up
                                @endif
                            </p>
                        </a>
