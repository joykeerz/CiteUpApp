              ...
              <div class="tab-content m-t-20">
                ...
                <div class="tab-pane" id="tab21">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="address1" type="text" class="form-control @error('asekolah') is-invalid @enderror" value="{{ old('asekolah') }}" name="asekolah"></textarea>
                  </div>
                  <ul class="pager wizard pager_a_cursor_pointer">
                ...
                <div class="tab-pane" id="tab31">
                  <div class="form-group row m-t-35">
                    <div class="col-lg-3 text-center text-lg-right">
                      <label class="col-form-label">Pas Foto<br><i>(.jpg atau .png)</i></label>
                    </div>
                    <div class="col-lg-6 text-center text-lg-left">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new img-thumbnail text-center">
                          <img src="{{old('pas_foto')}}" alt="Image" class="profile_img">
                        </div>
                  ...
                  <div class="form-group row m-t-35">
                    <div class="col-lg-3 text-center text-lg-right">
                      <label class="col-form-label">Kartu Pelajar<br><i>(.jpg atau .png)</i></label>
                    </div>
                    <div class="col-lg-6 text-center text-lg-left">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new img-thumbnail text-center">
                          <img src="{{old('kartu_pelajar')}}" alt="Image" class="profile_img">
                        </div>
                        <div class="fileinput-preview fileinput-exists img-thumbnail">
                        </div>
                        <div class="m-t-20 text-center">
