...
@section('content')
    ...
    @csrf
        ...
        -->
        <label for="kelompok" class="col-md-4 col-form-label text-md-right">{{ __('Apakah Anda ') }}<i class="fa fa-child text-primary"></i></label>
            <div class="col-md-6">
                <div class="form-group">
                        <select class="form-control" id="jenispeserta" name="jenispeserta" value="{{ old('jenispeserta') }}" required autocomplete="jenispeserta" autofocus>
